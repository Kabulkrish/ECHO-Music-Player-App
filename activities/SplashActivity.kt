package com.example.manisha.echo.activities
...
import com.example.manisha.echo.R
    ...
    override fun onRequestPermissionsResult(requestCode: Int, permissions: Array<out String>, grantResults: IntArray) {
        ...
        when(requestCode){
            131->{
                ...
                {
                    Toast.makeText(this@SplashActivity,"Please grant all the permission!",Toast.LENGTH_SHORT).show()
                    this.finish()
                }
            }
            else->{
